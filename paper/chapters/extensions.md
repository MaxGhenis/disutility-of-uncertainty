...
The National Taxpayers Union Foundation estimates that U.S. taxpayers spend approximately \$260 billion annually on tax compliance, including both time costs and out-of-pocket expenses {cite:p}`ntu2023complexity`. This expenditure represents the private sector's partial response to the misperception problem. In a world with transparent marginal rates, much of it would be unnecessary. The existence and scale of compliance spending is thus independent evidence that marginal-rate misperception is economically costly. Public simplification efforts that reduce $\sigma$ for all workers simultaneously capture scale economies that private information acquisition cannot, and they reduce both the behavioral DWL and compliance expenditure.
