...
class TestOptimalChoice:
    ...
    def test_optimal_leisure_with_transfers(self):
        ...
        optimal_l = choice.optimal_leisure(
            wage=10, tax_rate=0.2, transfers=50, total_hours=24
        )
    ...
    def test_optimal_leisure_corner_solution(self):
        ...
        optimal_l = choice.optimal_leisure(
            wage=10, tax_rate=0.2, transfers=1000, total_hours=24
        )
    ...
    def test_labor_supply(self):
        ...
        labor = choice.labor_supply(wage=10, tax_rate=0.2, transfers=0, total_hours=24)
